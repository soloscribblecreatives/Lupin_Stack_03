...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/1.jpg" width="1024" height="768" alt=""></div><script>runAnimation();</script>';
	break;
	case 2:
...
/* 
	...
	if(page_id == 1){
	document.getElementById("click_through").innerHTML='<canvas ontouchend="mouseUp()" id="board" width="564" height="344"></canvas><footer><input type="color" id="colorPicker" value="#000000">';
		}
    if(page_id == 2){
	document.getElementById("click_through").innerHTML='';
		}
