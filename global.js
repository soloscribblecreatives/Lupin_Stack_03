...
/* 
	...
	if(page_id == 1){
	document.getElementById("click_through").innerHTML='<canvas onmouseup="mouseUp()" id="board" width="564" height="344"></canvas><footer><input type="color" id="colorPicker" value="#000000">';
		}
    if(page_id == 2){
	document.getElementById("click_through").innerHTML='';
		}
