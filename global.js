...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="s1_1"><img src="slide1/s1_1.png"/></div><div class="s1_2"><img src="slide1/s1_2.png"/></div><div class="s1_3"><img src="slide1/s1_3.png"/></div><div class="option1" onclick="option1();"></div><div class="option2" onclick="option2();"></div>';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="s2_1"><img src="slide2/s2_1.png" width="1024" height="768" alt=""></div><div class="s2_2"><img src="slide2/s2_2.png"></div>';
	break;
    case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="launch" onclick="blast();"><img src="slide3/8.png"/></div><div class="s3_1"><img src="slide3/1.png" width="1024" height="768"/></div><div class="s3_2"><img src="slide3/2.png"/></div><div class="s3_3"><img src="slide3/3.png"/></div><div class="s3_5"><img src="slide3/5.png"/></div><div class="s3_6"><img src="slide3/6.png"/></div><div class="s3_7"><img src="slide3/7.gif" width="1024" height="768"/></div>';
	break;
	case 4:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="background"><img src="slide4/1.jpg" width="1024" height="768" alt=""></div>';
	break;
	case 5:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="background"><img src="slide5/1.jpg" width="1024" height="768" alt=""></div>';
	break;
	case 6:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="background"><img src="slide6/1.jpg" width="1024" height="768" alt=""></div>';
	break;
	case 7:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="background"><img src="slide7/1.jpg" width="1024" height="768" alt=""></div>';
	break;
}
...
function blast() {
	...
	$(".s3_5").addClass("s3_5_slide");
	$(".s3_6").addClass("s3_6_slide");
	setTimeout(function () {
		$('.s3_7').css("display","block");
	}, 3000);
}